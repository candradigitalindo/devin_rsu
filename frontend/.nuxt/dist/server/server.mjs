import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, unref, version, defineComponent, computed, provide, ref, watch, h, shallowRef, isReadonly, isReactive, toRaw, isRef, isShallow, resolveComponent, Suspense, nextTick, Fragment, Transition, mergeProps, withCtx, createTextVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
...
const unhead_lujPChMbGd = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "billing",
    path: "/billing",
    component: () => import("./_nuxt/index-MNdroez7.js").then((m) => m.default || m)
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import("./_nuxt/dashboard-IXgCxJVE.js").then((m) => m.default || m)
  },
  {
    name: "pharmacy-dispensing",
    path: "/pharmacy/dispensing",
    component: () => import("./_nuxt/dispensing-CmOa89Uh.js").then((m) => m.default || m)
  },
  {
    name: "pharmacy",
    path: "/pharmacy",
    component: () => import("./_nuxt/index-BklAYvg9.js").then((m) => m.default || m)
  },
  {
    name: "reports-expiry",
    path: "/reports/expiry",
    component: () => import("./_nuxt/expiry-BP9x8sU4.js").then((m) => m.default || m)
  }
];
...
const revive_payload_server_rkCVT7QzlP = /* @__PURE__ */ defineNuxtPlugin({
...
const http_U6xsJGI3U5 = /* @__PURE__ */ defineNuxtPlugin(() => {
  const config = /* @__PURE__ */ useRuntimeConfig();
  const base = config.public.apiBaseUrl;
  const api = ofetch.create({
    baseURL: base,
    onRequest({ options }) {
      const host = (void 0).location.hostname;
...
const plugins = [
  unhead_lujPChMbGd,
  plugin,
  revive_payload_server_rkCVT7QzlP,
...
function defineNuxtLink(options) {
  ...
  function useNuxtLink(props) {
    ...
    const href = computed(() => {
      var _a;
      return typeof to.value === "object" ? ((_a = router.resolve(to.value)) == null ? void 0 : _a.href) ?? null : to.value && !props.external && !isAbsoluteUrl.value ? resolveTrailingSlashBehavior(joinURL(config.app.baseURL, to.value), router.resolve) : to.value;
    });
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const tenantSlug = computed(() => {
      const h2 = (void 0).location.hostname.split(".");
      if (h2.length > 2) return h2[0];
      return "demo";
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      const _component_NuxtPage = __nuxt_component_1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "app" }, _attrs))}><header class="header"><h1>SaaS Klinik/RS</h1><div class="tenant">${ssrInterpolate(unref(tenantSlug))}</div></header><nav class="nav">`);
      ...
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/pharmacy" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Farmasi`);
          } else {
            return [
              createTextVNode("Farmasi")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/billing" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Billing`);
          } else {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/reports/expiry" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Expiry`);
          } else {
            return [
              createTextVNode("Expiry")
            ];
          }
        }),
        _: 1
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-B-EFqQGq.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-C3EcwSZH.js").then((r) => r.default || r));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.12.0_@parcel+watcher@2.5.1_db0@0.3.2_eslint@8.57.1_ioredis@5.7.0_magicast@0.3.5_option_th57qugdqeqofwiitkkkl5lhiu/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.12.0_@parcel+watcher@2.5.1_db0@0.3.2_eslint@8.57.1_ioredis@5.7.0_magicast@0.3.5_option_th57qugdqeqofwiitkkkl5lhiu/node_modules/nuxt/dist/app/components/nuxt-root.vue");
