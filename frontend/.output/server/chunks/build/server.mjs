import { defineComponent, ref, h, resolveComponent, inject, unref, computed, hasInjectionContext, getCurrentInstance, version, provide, shallowReactive, watch, Suspense, nextTick, Fragment, Transition, useSSRContext, createApp, mergeProps, withCtx, createTextVNode, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, shallowRef, isReadonly, isReactive, toRaw, isRef, isShallow, defineAsyncComponent, getCurrentScope } from 'vue';
import { h as getContext, s as sanitizeStatusCode, $ as $fetch, i as createHooks, c as createError$1, o as ofetch, t as toRouteMatcher, k as createRouter$1 } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "billing",
    path: "/billing",
    component: () => import('./index-MNdroez7.mjs').then((m) => m.default || m)
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./dashboard-IXgCxJVE.mjs').then((m) => m.default || m)
  },
  {
    name: "pharmacy-dispensing",
    path: "/pharmacy/dispensing",
    component: () => import('./dispensing-CmOa89Uh.mjs').then((m) => m.default || m)
  },
  {
    name: "pharmacy",
    path: "/pharmacy",
    component: () => import('./index-BklAYvg9.mjs').then((m) => m.default || m)
  },
  {
    name: "reports-expiry",
    path: "/reports/expiry",
    component: () => import('./expiry-BP9x8sU4.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-B-EFqQGq.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-C3EcwSZH.mjs').then((r) => r.default || r));
...
export { __nuxt_component_0 as _, entry$1 as default, injectHead as i, resolveUnrefHeadInput as r, useNuxtApp as u };
